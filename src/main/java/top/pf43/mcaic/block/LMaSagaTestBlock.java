...
public class LMaSagaTestBlock extends Block {
	public static BlockBehaviour.Properties PROPERTIES = BlockBehaviour.Properties.of().instrument(NoteBlockInstrument.BASEDRUM).sound(SoundType.STONE).strength(1f, 10f).lightLevel(s -> 15).noCollission().noOcclusion()
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(McaicModBlocks.L_MA_SAGA_TEST, RenderType.solid());
	}
}
