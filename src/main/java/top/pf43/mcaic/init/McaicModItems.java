...
public class McaicModItems {
	...
	public static Item L_MA_ROGE;
	public static Item L_MA_SAGA_TEST;
	public static Item MA_SAGA_TEST;
	public static Item TEST_1_SPAWN_EGG;
	...
	public static void load() {
		...
		L_MA_ROGE = Registry.register(BuiltInRegistries.ITEM, new ResourceLocation(McaicMod.MODID, "l_ma_roge"), new BlockItem(McaicModBlocks.L_MA_ROGE, new Item.Properties()));
		ItemGroupEvents.modifyEntriesEvent(McaicModTabs.TAB_MCAIC).register(content -> content.accept(L_MA_ROGE));
		L_MA_SAGA_TEST = Registry.register(BuiltInRegistries.ITEM, new ResourceLocation(McaicMod.MODID, "l_ma_saga_test"), new BlockItem(McaicModBlocks.L_MA_SAGA_TEST, new Item.Properties()));
		ItemGroupEvents.modifyEntriesEvent(McaicModTabs.TAB_MCAIC).register(content -> content.accept(L_MA_SAGA_TEST));
		MA_SAGA_TEST = Registry.register(BuiltInRegistries.ITEM, new ResourceLocation(McaicMod.MODID, "ma_saga_test"), new BlockItem(McaicModBlocks.MA_SAGA_TEST, new Item.Properties()));
		ItemGroupEvents.modifyEntriesEvent(McaicModTabs.TAB_MCAIC).register(content -> content.accept(MA_SAGA_TEST));
		TEST_1_SPAWN_EGG = Registry.register(BuiltInRegistries.ITEM, new ResourceLocation(McaicMod.MODID, "test_1_spawn_egg"), new SpawnEggItem(McaicModEntities.TEST_1, -1, -16777216, new Item.Properties()));
		ItemGroupEvents.modifyEntriesEvent(McaicModTabs.TAB_MCAIC).register(content -> content.accept(TEST_1_SPAWN_EGG));
	}
